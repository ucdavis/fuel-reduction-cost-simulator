...
function Skidding(input: InputVarMod, intermediate: IntermediateVarMod,
    ...
    const TurnVol = (!input.PartialCut ?
        44.87 : (input.PartialCut ? 31.62 : 0)) * Math.pow(intermediate.TreeVol, 0.282)
    ...
    + 0.037 * ChokerTurnVol + 4.05 * Math.log(input.DeliverDist + WinchDistSkidIA);
    ...
    const TurnTimeSkidIB = 2.74 + 0.726 * ChokerLogs + 0.00363 * ChokerTurnVol * intermediate.BFperCF
        + 0.0002 * ChokerTurnVol * intermediate.WoodDensity + 0.00777 * input.DeliverDist
    ...
    const TurnTimeSkidIC = 60 * ((0.122 + 0.089) + (0.000229 + 0.000704) * input.DeliverDist
    ...
    const TurnTimeSkidIIA = 0.518 + 0.0107 * input.DeliverDist + 0.0011 * Math.pow(input.Slope, 3)
    ...
    const TurnTimeSkidIIB = 1.072 + 0.00314 * input.DeliverDist + 0.0192 * input.Slope + 0.315 * TypeOfCutSkidIIB
    ...
    const TravEmptySkidIVA = -2.179 + 0.0362 * input.Slope + 0.711 * Math.log(input.DeliverDist);
    const LoadSkidIVA = Math.max(0, 0.882 + 0.0042 * Math.pow(input.Slope, 2) - 0.000048 * Math.pow(TreesPerTurnS, 3));
    const TravLoadedSkidIVA = -0.919 + 0.00081 * input.DeliverDist + 0.000062 * Math.pow(input.Slope, 3)
    ...
    const TravEmptySkidIVB = (0.1905 * input.DeliverDist + 0.3557 * SkidderHpSkidIVB
    - 0.0003336 * input.DeliverDist * SkidderHpSkidIVB) / 100;
    ...
    const TravLoadedSkidIVB = (-34.52 + 0.2634 * input.DeliverDist + 0.7634 * SkidderHpSkidIVB
    - 0.00122 * input.DeliverDist * SkidderHpSkidIVB + 0.03782 * input.DeliverDist * BunchesPerTurnSkidIVB) / 100;
    ...
    * (TravEmptySkidIVB + GrappleSkidIVB + TravLoadedSkidIVB + UngrappleSkidIVB);
    ...
    const TurnTimeSkidIVC = 0.65 + 0.0054 * input.DeliverDist + 0.244 * LoadingStopsSkidIVC;
    ...
    const TurnTimeSkidIVE = 0.649 + 0.0058 * input.DeliverDist + 0.581 * BunchesPerTurnSkidIVE;
    ...
    const TurnTimeSkidIVG = 2.98 + 0.006 * input.DeliverDist + 0.27 * TreesPerTurnSkidIVG;
