...
function CYPCU(assumption: AssumptionMod, input: InputVarMod, intermediate: IntermediateVarMod,
    ...
    const TurnTimeIIAcable = 1.51 + 0.012 * TurnVol2 + 0.011 * DeckHeightIIAcable * LogsII
        + 0.021 * DeckHeightIIAcable * TurnEndAreaIIAcable + 0.004 * (input.DeliverDist + LatDist)
    ...
    const TurnTimeIIBcable = 1.82 + 0.0024 * input.DeliverDist + 0.00021 * Math.pow(LatDist, 2)
    ...
    const TurnTimeIICcable = Math.exp(1.46 + 0.000486 * input.DeliverDist + 0.00114 * LatDist
    ...
    const TurnTimeIIDcable = Math.exp(0.58 + 0.192 * Math.log(input.DeliverDist)
    ...
    const TurnTimeIIEcable = Math.exp(1.813 + 0.00094 * input.DeliverDist - 0.0095 * input.Slope
    ...
    const TurnTimeIIGcable = 2.761 + 0.0014 * input.DeliverDist + 0.0114 * LatDist;
    ...
    const TurnTimeIIHcable = 2.341 + 0.0017 * input.DeliverDist + 0.012 * LatDist + 0.722 * PresetIIHcable
    ...
    const TurnTimeIIIcable = 0.231 + 0.003 * input.DeliverDist + 0.01 * LatDist + 0.017 * CarriageHtIIIcable
    ...
    const TurnTimeIIJcable = 0.223 + 0.004 * input.DeliverDist + 0.024 * LatDist
    ...
    const VolPerPMHIIKcable = 44.09 / (-0.089289 + (81.991053 / intermediate.VolPerAcre)
        + (0.000269 * input.DeliverDist) + (-496.820821 / (intermediate.VolPerAcre * intermediate.DBH))
    ...
    const RelevanceIILcable = (intermediate.DBH >= 5 && intermediate.DBH <= 9 && input.DeliverDist <= 500) ? 1 : 0;
    ...
    const VolPerPMHIIMcable = 70.45 / (0.12577 + (-0.00328 * intermediate.DBH) + (0.000048 * input.DeliverDist)
    ...
    const VolPerPMHIINcable = 55.77 / (0.707187 + (-0.050285 * intermediate.DBH)
        ...
        + (0.000168 * input.DeliverDist) + (-2.095831 / intermediate.DBH)); // regression
    ...
    const VolPerPMHIIOcable = 121.65 / (0.090775 + (0.000071 * input.DeliverDist)
