...
function FellwtChipLogOther(input: InputVarMod, intermediate: IntermediateVarMod, CostMachine: CostMachineMod) {
    ...
    const OpeningsIIB = 0;
    const HeavyThinIIB = 0;
    const DelayFracIIB = 0.25;
    const TimePerTreeIIB
        = (-0.465 + 0.102 * intermediate.DBHALT + 0.016 * LimbsIIB + 0.562 * LogsIIB + 0.009 * input.Slope
    ...
    return {
        'CostManFellCT2': CostManFellCT2, 'CostManFLBALT2': CostManFLBALT2
    };
}
