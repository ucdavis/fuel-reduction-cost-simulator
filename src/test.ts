...
test('testCableCTL', () => {
  ...
  expect(parseFloat(res.total.yieldPerAcre.toFixed(8))).toBe(22.06948616);
  expect(parseFloat(res.total.costPerAcre.toFixed(6))).toBe(1475.913722);
  expect(parseFloat(res.total.costPerBoleCCF.toFixed(7))).toBe(236.4754217);
  expect(parseFloat(res.total.costPerGT.toFixed(8))).toBe(66.87576283);
  expect(parseFloat(res.total.dieselPerAcre.toFixed(8))).toBe(22.36644989);
  expect(parseFloat(res.total.dieselPerBoleCCF.toFixed(9))).toBe(3.583621178);
  expect(parseFloat(res.total.gasolinePerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.gasolinePerBoleCCF.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.jetFuelPerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.jetFuelPerBoleCCF.toFixed(0))).toBe(0);
  ...
  expect(parseFloat(res.residual.yieldPerAcre.toFixed(9))).toBe(6.456291679);
  expect(parseFloat(res.residual.costPerAcre.toFixed(6))).toBe(431.883024);
  expect(parseFloat(res.residual.costPerBoleCCF.toFixed(8))).toBe(69.19762227);
  expect(parseFloat(res.residual.costPerGT.toFixed(8))).toBe(19.56923786);
  expect(parseFloat(res.residual.dieselPerAcre.toFixed(9))).toBe(7.259539152);
  expect(parseFloat(res.residual.dieselPerBoleCCF.toFixed(9))).toBe(1.163145621);
  expect(parseFloat(res.residual.gasolinePerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.gasolinePerBoleCCF.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.jetFuelPerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.jetFuelPerBoleCCF.toFixed(0))).toBe(0);
...
test('testHelicopterCtl', () => {
  ...
  expect(parseFloat(res.total.yieldPerAcre.toFixed(8))).toBe(22.06948616);
  expect(parseFloat(res.total.costPerAcre.toFixed(6))).toBe(1301.274018);
  expect(parseFloat(res.total.costPerBoleCCF.toFixed(7))).toBe(208.4941128);
  expect(parseFloat(res.total.costPerGT.toFixed(8))).toBe(58.96258792);
  expect(parseFloat(res.total.dieselPerAcre.toFixed(9))).toBe(8.937338816);
  expect(parseFloat(res.total.dieselPerBoleCCF.toFixed(9))).toBe(1.431967827);
  expect(parseFloat(res.total.gasolinePerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.gasolinePerBoleCCF.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.jetFuelPerAcre.toFixed(8))).toBe(39.91362045);
  expect(parseFloat(res.total.jetFuelPerBoleCCF.toFixed(9))).toBe(6.395082643);

  expect(parseFloat(res.residual.yieldPerAcre.toFixed(9))).toBe(6.456291679);
  expect(parseFloat(res.residual.costPerAcre.toFixed(7))).toBe(385.9430324);
  expect(parseFloat(res.residual.costPerBoleCCF.toFixed(8))).toBe(61.83697596);
  expect(parseFloat(res.residual.costPerGT.toFixed(7))).toBe(17.4876311);
  expect(parseFloat(res.residual.dieselPerAcre.toFixed(9))).toBe(1.642562703);
  expect(parseFloat(res.residual.dieselPerBoleCCF.toFixed(9))).toBe(0.263176432);
  expect(parseFloat(res.residual.gasolinePerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.gasolinePerBoleCCF.toFixed(0))).toBe(0);
...
test('testPartialCut', () => {
  ...
  expect(parseFloat(res.total.yieldPerAcre.toFixed(8))).toBe(37.87998061);
  expect(parseFloat(res.total.costPerAcre.toFixed(7))).toBe(696.5580064);
  expect(parseFloat(res.total.costPerBoleCCF.toFixed(8))).toBe(69.95408184);
  expect(parseFloat(res.total.costPerGT.toFixed(8))).toBe(18.38855235);
  expect(parseFloat(res.total.dieselPerAcre.toFixed(8))).toBe(14.30636276);
  expect(parseFloat(res.total.dieselPerBoleCCF.toFixed(8))).toBe(1.43676257);
  expect(parseFloat(res.total.gasolinePerAcre.toFixed(9))).toBe(0.289099958);
  expect(parseFloat(res.total.gasolinePerBoleCCF.toFixed(9))).toBe(0.029033795);
  expect(parseFloat(res.total.jetFuelPerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.jetFuelPerBoleCCF.toFixed(0))).toBe(0);
  ...
  expect(parseFloat(res.residual.yieldPerAcre.toFixed(8))).toBe(11.55664724);
  expect(parseFloat(res.residual.costPerAcre.toFixed(7))).toBe(166.9937862);
  expect(parseFloat(res.residual.costPerBoleCCF.toFixed(8))).toBe(16.77088897);
  expect(parseFloat(res.residual.costPerGT.toFixed(9))).toBe(4.408497141);
  expect(parseFloat(res.residual.dieselPerAcre.toFixed(9))).toBe(4.733662234);
  expect(parseFloat(res.residual.dieselPerBoleCCF.toFixed(9))).toBe(0.47539328);
  expect(parseFloat(res.residual.gasolinePerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.gasolinePerBoleCCF.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.jetFuelPerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.jetFuelPerBoleCCF.toFixed(0))).toBe(0);
...
test('testBiomassSalvage', () => {
  ...
  expect(parseFloat(res.total.yieldPerAcre.toFixed(8))).toBe(37.87998061);
  expect(parseFloat(res.total.costPerAcre.toFixed(7))).toBe(665.9811065);
  expect(parseFloat(res.total.costPerBoleCCF.toFixed(8))).toBe(66.88329817);
  expect(parseFloat(res.total.costPerGT.toFixed(8))).toBe(17.58134761);
  expect(parseFloat(res.total.dieselPerAcre.toFixed(8))).toBe(19.11031502);
  expect(parseFloat(res.total.dieselPerBoleCCF.toFixed(9))).toBe(1.919214952);
  expect(parseFloat(res.total.gasolinePerAcre.toFixed(9))).toBe(0.289099958);
  expect(parseFloat(res.total.gasolinePerBoleCCF.toFixed(9))).toBe(0.029033795);
  expect(parseFloat(res.total.jetFuelPerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.jetFuelPerBoleCCF.toFixed(0))).toBe(0);

  expect(parseFloat(res.residual.yieldPerAcre.toFixed(8))).toBe(37.87998061);
  expect(parseFloat(res.residual.costPerAcre.toFixed(7))).toBe(665.9811065);
  expect(parseFloat(res.residual.costPerBoleCCF.toFixed(8))).toBe(66.88329817);
  expect(parseFloat(res.residual.costPerGT.toFixed(8))).toBe(17.58134761);
  expect(parseFloat(res.residual.dieselPerAcre.toFixed(8))).toBe(19.11031502);
  expect(parseFloat(res.residual.dieselPerBoleCCF.toFixed(9))).toBe(1.919214952);
  expect(parseFloat(res.residual.gasolinePerAcre.toFixed(9))).toBe(0.289099958);
  expect(parseFloat(res.residual.gasolinePerBoleCCF.toFixed(9))).toBe(0.029033795);
  expect(parseFloat(res.residual.jetFuelPerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.residual.jetFuelPerBoleCCF.toFixed(0))).toBe(0);
});
...
test('testExcludeLoadingCosts', () => {
  ...
  expect(parseFloat(res.total.yieldPerAcre.toFixed(8))).toBe(37.87998061);
  expect(parseFloat(res.total.costPerAcre.toFixed(7))).toBe(547.7240581);
  expect(parseFloat(res.total.costPerBoleCCF.toFixed(7))).toBe(55.0069531);
  expect(parseFloat(res.total.costPerGT.toFixed(8))).toBe(14.45945983);
  expect(parseFloat(res.total.dieselPerAcre.toFixed(8))).toBe(11.24011796);
  expect(parseFloat(res.total.dieselPerBoleCCF.toFixed(9))).toBe(1.128825058);
  expect(parseFloat(res.total.gasolinePerAcre.toFixed(9))).toBe(0.289099958);
  expect(parseFloat(res.total.gasolinePerBoleCCF.toFixed(9))).toBe(0.029033795);
  expect(parseFloat(res.total.jetFuelPerAcre.toFixed(0))).toBe(0);
  expect(parseFloat(res.total.jetFuelPerBoleCCF.toFixed(0))).toBe(0);
