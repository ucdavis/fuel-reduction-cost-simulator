...
function CYPCU(
  ...
  const TurnTimeIIAcable =
    ...
    0.004 * (input.DeliverDist + LatDist) +
  ...
  const RelevanceIIAcable =
    intermediate.TreeVol < 10
      ? 1
      : intermediate.TreeVol < 20
      ? 2 - intermediate.TreeVol / 10
      : 0;
  const WeightingProductIIAcable =
    VolPerPMHIIAcable * CostPerCCFIIAcable * RelevanceIIAcable;
  ...
  const RelevanceIIBcable =
    TurnVol2 < 200 ? 1 : TurnVol2 < 400 ? 2 - TurnVol2 / 200 : 0;
  const WeightingProductIIBcable =
    VolPerPMHIIBcable * CostPerCCFIIBcable * RelevanceIIBcable;
  ...
  const RelevanceIICcable =
    intermediate.LogVol < 30
      ...
      : 0;
  const WeightingProductIICcable =
    VolPerPMHIICcable * CostPerCCFIICcable * RelevanceIICcable;
  ...
  const TurnTimeIIDcable = Math.exp(
    0.58 +
      0.192 * Math.log(input.DeliverDist) -
      0.00308 * input.Slope +
      0.00193 * LatDist +
  ...
  const RelevanceIIDcable =
    intermediate.LogVol < 30
      ...
      ? 2 - intermediate.LogVol / 30
      : 0;
  const WeightingProductIIDcable =
    VolPerPMHIIDcable * CostPerCCFIIDcable * RelevanceIIDcable;
  ...
  const WeightingProductIIEcable =
    VolPerPMHIIEcable * CostPerCCFIIEcable * RelevanceIIEcable;
  ...
  const TurnTimeIIFcable = 3.73 + 0.0028 * input.DeliverDist + 0.154 * LatDist;
  ...
  const RelevanceIIFcable =
    intermediate.TreeVol < 90
      ...
      : 0;
  const WeightingProductIIFcable =
    VolPerPMHIIFcable * CostPerCCFIIFcable * RelevanceIIFcable;
  ...
  const TurnTimeIIGcable =
    2.761 + 0.0014 * input.DeliverDist + 0.0114 * LatDist;
  ...
  const RelevanceIIGcable =
    intermediate.TreeVol < 90
      ...
      ? 2 - intermediate.TreeVol / 90
      : 0;
  const WeightingProductIIGcable =
    VolPerPMHIIGcable * CostPerCCFIIGcable * RelevanceIIGcable;
  ...
  const RelevanceIIHcable =
    intermediate.TreeVol < 60
      ? 1
      : intermediate.TreeVol < 120
      ? 2 - intermediate.TreeVol / 60
      : 0;
  const WeightingProductIIHcable =
    VolPerPMHIIHcable * CostPerCCFIIHcable * RelevanceIIHcable;
  ...
  const RelevanceIIIcable =
    intermediate.TreeVol < 70
      ? 1
      : intermediate.TreeVol < 140
      ? 2 - intermediate.TreeVol / 70
      : 0;
  const WeightingProductIIIcable =
    VolPerPMHIIIcable * CostPerCCFIIIcable * RelevanceIIIcable;
  ...
  const TurnTimeIIJcable =
    0.223 +
    0.004 * input.DeliverDist +
    0.024 * LatDist +
    0.059 * TurnVol2 +
    35.23 / intermediate.TreeVol;
  ...
  const RelevanceIIJcable =
    intermediate.TreeVol < 5
      ...
      : 0;
  const WeightingProductIIJcable =
    VolPerPMHIIJcable * CostPerCCFIIJcable * RelevanceIIJcable;
  ...
  const RelevanceIIKcable =
    intermediate.DBH >= 7 && intermediate.DBH <= 24 ? 1 : 0;
  const RelevanceIIKcable2 = Math.min(RelevanceIIKcable, 0);
  const WeightingProductIIKcable =
    VolPerPMHIIKcable * CostPerCCFIIKcable * RelevanceIIKcable2;
  ...
  const VolPerPMHIILcable =
    ...
    (0.161995 +
      ...
      0.000172 * input.DeliverDist); // regression
  ...
  const RelevanceIILcable =
    intermediate.DBH >= 5 && intermediate.DBH <= 9 && input.DeliverDist <= 500
      ? 1
      : 0;
  const RelevanceIILcable2 = Math.min(RelevanceIILcable, 0);
  const WeightingProductIILcable =
    VolPerPMHIILcable * CostPerCCFIILcable * RelevanceIILcable2;
  ...
  const RelevanceIIMcable =
    intermediate.DBH >= 7 && intermediate.DBH <= 16 ? 1 : 0;
  const RelevanceIIMcable2 = Math.min(RelevanceIIMcable, 0);
  const WeightingProductIIMcable =
    VolPerPMHIIMcable * CostPerCCFIIMcable * RelevanceIIMcable2;
  ...
  const RelevanceIINcable =
    intermediate.DBH >= 7 && intermediate.DBH <= 24 ? 1 : 0;
  const RelevanceIINcable2 = Math.min(RelevanceIINcable, 0);
  const WeightingProductIINcable =
    VolPerPMHIINcable * CostPerCCFIINcable * RelevanceIINcable2;
  ...
  const RelevanceIIOcable =
    intermediate.DBH >= 7 && intermediate.DBH <= 24 ? 1 : 0;
  const RelevanceIIOcable2 = Math.min(RelevanceIIOcable, 0);
  const WeightingProductIIOcable =
    VolPerPMHIIOcable * CostPerCCFIIOcable * RelevanceIIOcable2;
  ...
  const WeightingProductIIPcable =
    VolPerPMHIIPcable * CostPerCCFIIPcable * RelevanceIIPcable;
